...
[Download WhatsApp Connector for macOS](https://github.com/raphaelcunha/whatsapp-connector/releases/download/v2.0/WhatsApp-Connector-2.0.dmg)
...
1. [Download the DMG](https://github.com/raphaelcunha/whatsapp-connector/releases/download/v2.0/WhatsApp-Connector-2.0.dmg).
2. Open the DMG.
